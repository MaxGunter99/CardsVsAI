...
import { Text, View, Image, Animated, StatusBar, SafeAreaView, ScrollView } from 'react-native';
...
import EgyptionRatScrew from './Components/Games/EgyptionRatScrew';
            ...
            <NativeRouter>
                ...
                <View style={{ backgroundColor: 'black' }}>
                    ...
                    <SafeAreaView>
                        ...
                        <Animated.ScrollView style = {{ opacity: this.state.fadeAnimationOne }}>
                            <Route path="/GameList" component={() => (<GameList {...this.state} toggleNav={ this.toggleFadeAnimation } />)} />
                        </Animated.ScrollView>

                        <Route path="/EgyptionRatScrew" component={ EgyptionRatScrew } />
